    ...
    if (oldParentId !== null) {
      ...
      let sql =
        dialect === 'postgres'
          ? `
          DELETE
          FROM * through USING *through AS descendents, *through AS ancestors
